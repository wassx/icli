...
### Atomic Commits
- **MUST make atomic commits**: Each commit should represent a single logical change
- **One feature/fix per commit**: Avoid combining unrelated changes
- **Small, focused changes**: Easier to review and revert if needed
- **Generated commit messages**: Use the standard format with co-author attribution
